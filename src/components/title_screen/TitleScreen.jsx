...
const TitleScreen = () => {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center w-full text-center text-white ">
      <h1 className="mb-4 text-3xl font-extrabold  text-white md:text-5xl lg:text-6xl transition">
      ...
      <i className="text-sm font-normal text-gray-500 lg:text-xl dark:text-gray-400">
